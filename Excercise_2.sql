...
# ____________________________Excercise starts here___________________________________
#1
...
SELECT * FROM customers WHERE NOT Country='Canada' AND NOT Country='USA';

#7
SELECT * FROM orders;
SELECT * FROM order_details;
SELECT * FROM order_details JOIN orders ON orders.OrderId = order_details.OrderId WHERE orders.OrderDate BETWEEN '2020-01-01' AND '2021-12-31' ORDER BY orders.OrderDate DESC;
...
SELECT * FROM employees WHERE NOT LastName='Soniya' AND NOT LastName='Sanjay';
SELECT * FROM employees WHERE NOT FirstName='Soniya' AND NOT FirstName='Sanjay';
...
INSERT INTO supplier_details SELECT * FROM suppliers;
SELECT * FROM supplier_details;

#11
SELECT * FROM customers;
#Initially got an error mentioned below so after some research I was able to execute this query by tweaking the query a bit.
